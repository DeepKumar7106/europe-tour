export const regions = [
  { 
    ...
    scale:1,
    name: "British-Isles",
    desc: "Lorem ipsum dolor sit, amet consectetur adipisicing eliy",
    x:"-10vh",
    y:"-5vh", 
  },
  { 
...
export const oldCities = [
  ...
  },
  {
    ...
    cityName: "Astana",
    countryId: "eur08",
    description: "Astana is a futuristic planned capital city on the steppes, featuring unique architectural landmarks designed by world-renowned architects, reflecting Kazakhstan's modern ambitions and growing international significance and presence.",
    bestSeason: "Summer",
    famousLocation: ["Bayterek Tower", "Khan Shatyr", "Hazrat Sultan Mosque", "Nur-Astana Mosque", "National Museum", "Expo 2017 Site"]
  },
  ...
  },
  {
    ...
    cityName: "Cappadocia",
    countryId: "eur03",
    description: "Cappadocia is a surreal landscape of fairy chimneys and cave dwellings, world-famous for its sunrise hot air balloon flights and ancient underground cities carved into the soft volcanic rock formations.",
    bestSeason: "Autumn",
    famousLocation: ["Goreme Open Air Museum", "Uchisar Castle", "Kaymakli Underground", "Ihlara Valley", "Devrent Valley", "Pasabag"]
  },
  {
    ...
    cityName: "Antalya",
    countryId: "eur03",
    description: "Antalya is a stunning Mediterranean resort city known for its historic old town of Kaleiçi, ancient Roman ruins, and beautiful beaches surrounded by the impressive Taurus Mountain range coastal scenery.",
    bestSeason: "Summer",
    famousLocation: ["Kaleiçi Old Town", "Hadrian's Gate", "Duden Waterfalls", "Aspendos Theatre", "Konyaaltı Beach", "Antalya Museum"]
  },
  ...
  // --- KOSOVO (eur06) ---
  {
    ...
    cityName: "Pristina",
    countryId: "eur06",
    description: "Pristina is Europe's youngest capital city, featuring a vibrant, youthful energy, unique landmarks like the National Library, and a rapidly growing coffee shop and modern international culture scene.",
    bestSeason: "Spring",
    famousLocation: ["NEWBORN Monument", "National Library", "Mother Teresa Boulevard", "Germia Park", "Ethnographic Museum", "Imperial Mosque"]
  },
  {
    ...
    cityName: "Prizren",
    countryId: "eur06",
    description: "Prizren is Kosovo's cultural capital, famous for its well-preserved Ottoman architecture, a historic stone bridge, and its dramatic hilltop fortress offering panoramic views over the city's many mosques and churches.",
    bestSeason: "Summer",
    famousLocation: ["Prizren Fortress", "Sinan Pasha Mosque", "Stone Bridge", "Shadervan Square", "League of Prizren", "Our Lady of Ljeviš"]
  },
  ...
  },
  {
    ...
    cityName: "Banska-Stiavnica",
    countryId: "eur04",
    description: "Banská Štiavnica is a UNESCO-listed historic mining town set within an ancient volcano, famous for its elegant architecture, historic tajchy reservoirs, and its beautifully preserved medieval city center and churches.",
    bestSeason: "Autumn",
    famousLocation: ["Old Castle", "New Castle", "Calvary", "Holy Trinity Square", "Open-Air Mining Museum", "Počúvadlo Lake"]
  }
];
